...
public class HttpHelper
{
	...
	private HttpResponse loadResponse(HttpUriRequest request)
	{
		...
		while (complete < NEED_TO_COMPLETE)
		{
			try
			{
				...
				HttpClient client = getHttpHelper();
	...
	private HttpClient getHttpHelper()
	{
		try {
	...
	private  String privateLoadByUrl(String sUrl)
	{
	...
	public  String loadPostByUrl(String sUrl, List<BasicNameValuePair> parameters)
	{
	...
	public  void loadFromProxy(GeoPoint geoPoint)
	{
		try
		{
