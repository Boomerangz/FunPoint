...
public abstract class PaintableObject {
    ...
    public void paintRoundRect(Canvas canvas, float x, float y, float width, float height) {
    	if (canvas==null) throw new NullPointerException();    	
        canvas.drawRoundRect(new RectF(x, y, x + width, y + height), 10, 10, paint);
    }
...
//        canvas.translate(x, y); //EArt: changed obj start draw position 
