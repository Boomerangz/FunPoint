	...
	private void applyTexture(GL10 gl) {
		if (frontBitmap != null) {
			...
			frontTopCard.setCardVertices(new float[] { 0f,
					frontBitmap.getHeight(), 0f, // top left
					0f, frontBitmap.getHeight() / 2.0f, 0f, // bottom left
					frontBitmap.getWidth(), frontBitmap.getHeight() / 2f, 0f, // bottom
																				// right
					frontBitmap.getWidth(), frontBitmap.getHeight(), 0f // top
																		// right
					});
			...
			frontTopCard.setTextureCoordinates(new float[] {
					...
					frontBitmap.getWidth() / (float) frontTexture.getWidth(),
					frontBitmap.getHeight() / 2f
							/ (float) frontTexture.getHeight(),
					frontBitmap.getWidth() / (float) frontTexture.getWidth(),
					0f });
			...
			frontBottomCard.setCardVertices(new float[] { 0f,
					frontBitmap.getHeight() / 2f, 0f, // top left
					0f, 0f, 0f, // bottom left
					frontBitmap.getWidth(), 0f, 0f, // bottom right
					frontBitmap.getWidth(), frontBitmap.getHeight() / 2f, 0f // top
																				// right
					});
			...
			frontBottomCard.setTextureCoordinates(new float[] {
					...
					frontBitmap.getHeight() / 2f
							/ (float) frontTexture.getHeight(),
					0f,
					frontBitmap.getHeight() / (float) frontTexture.getHeight(),
					frontBitmap.getWidth() / (float) frontTexture.getWidth(),
					frontBitmap.getHeight() / (float) frontTexture.getHeight(),
					frontBitmap.getWidth() / (float) frontTexture.getWidth(),
					frontBitmap.getHeight() / 2f
		...
		if (backBitmap != null) {
			...
			backTopCard.setCardVertices(new float[] { 0f,
					backBitmap.getHeight(), 0f, // top left
					0f, backBitmap.getHeight() / 2.0f, 0f, // bottom left
					backBitmap.getWidth(), backBitmap.getHeight() / 2f, 0f, // bottom
																			// right
					backBitmap.getWidth(), backBitmap.getHeight(), 0f // top
																		// right
					});
			...
			backBottomCard.setCardVertices(new float[] { 0f,
					backBitmap.getHeight() / 2f, 0f, // top left
					0f, 0f, 0f, // bottom left
					backBitmap.getWidth(), 0f, 0f, // bottom right
					backBitmap.getWidth(), backBitmap.getHeight() / 2f, 0f // top
																			// right
					});
			...
			backBottomCard.setTextureCoordinates(new float[] {
					...
					backBitmap.getHeight() / 2f
							/ (float) backTexture.getHeight(),
					0f,
					backBitmap.getHeight() / (float) backTexture.getHeight(),
...
//			return true;
		...
		case MotionEvent.ACTION_CANCEL:
			System.out.println("TEXTURE_ACTION_CANCEL");
			delta = lastY - event.getY();
			rotateBy(180 * delta / frontTexture.getContentHeight()
					* MOVEMENT_RATE);
			if (angle < 90)
